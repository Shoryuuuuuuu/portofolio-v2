// Paste kode yang saya berikan sebelumnya di sini
import React from 'react';

const WhatsAppButton = () => {
  const phoneNumber = "6281281229084"; // PASTIkan gunakan kode negara tanpa "+"
  const message = "Hi Achmad, I saw your portfolio and I'd like to discuss a project.";
